...
Chiaro is intentionally light-only. Its white surface and lavender-to-pink
accent palette are defined in `source/css/_colors/chiaro.styl`; there is no
browser color-mode switch.
