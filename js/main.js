...
$(document).ready(function() {
  ...
  /**
   * Shows or hides the site-wide navigation menu.
   */
  ...
  function setNavigationExpanded(expanded) {
    ...
    header.classList.toggle("nav-collapsed", !expanded);
    document.body.classList.toggle("site-nav-expanded", expanded);
    navPanel.setAttribute("aria-hidden", String(!expanded));
    navPanel.toggleAttribute("inert", !expanded);
    navToggle.setAttribute("aria-expanded", String(expanded));
    navToggle.setAttribute("aria-label", expanded ? "Hide navigation" : "Show navigation");
    navToggle.setAttribute("title", expanded ? "Hide navigation" : "Show navigation");
  }
